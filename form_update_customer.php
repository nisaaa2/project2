...
$data = $db->query("SELECT * FROM customer WHERE id='$_GET[id]'");
$customer = $data->fetch();
?>
                                            ...
                                            <form method="POST" action="update_customer.php">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="id" name="id" type="text" class="form-control" value="<?= $customer['id'] ?>">
                                                    </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                    <div class="input-group">
                                                        <input id="gender" name="gender" type="text" class="form-control" value="<?= $customer['gender'] ?>">
                                                    </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                    <div class="input-group">
                                                        <input id="card_id" name="card_id" type="text" class="form-control" value="<?= $customer['card_id'] ?>">
                                                    </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
